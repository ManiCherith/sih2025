...
class CivicConnectApp {
    ...
    loadSampleData() {
        ...
        this.issues = [
            {
                ...
                category: "potholes",
                description: "Deep pothole causing vehicle damage near intersection with Oak Avenue",
                location: "Main Street & Oak Avenue",
                coordinates: [40.7128, -74.0060],
                priority: "high",
                status: "in-progress",
                submittedBy: "John D.",
                submittedDate: "2025-01-09T10:30:00Z",
                assignedTo: "Public Works Department",
                assignedDate: "2025-01-09T14:15:00Z",
            ...
            },
            {
                ...
                description: "Streetlight out for 3 weeks, creating safety hazard",
                location: "Pine Street, block 400",
                ...
                assignedDate: "2025-01-08T09:20:00Z",
                estimatedCompletion: "2025-01-18",
                upvotes: 12,
                comments: 2,
                imageUrl: "placeholder-streetlight.jpg"
            },
            {
                id: "CIV-2025-003",
                title: "Overflowing garbage bin",
                category: "garbage",
                description: "Public waste bin overflowing for several days, attracting pests",
                location: "Central Park entrance",
                coordinates: [40.7831, -73.9712],
                priority: "medium",
                status: "resolved",
                submittedBy: "David L.",
                submittedDate: "2025-01-03T12:15:00Z",
                assignedTo: "Sanitation Department",
                assignedDate: "2025-01-03T15:30:00Z",
                resolvedDate: "2025-01-04T10:00:00Z",
                upvotes: 8,
                comments: 1,
                imageUrl: "placeholder-garbage.jpg"
            },
            {
                id: "CIV-2025-004",
                ...
                status: "submitted",
                submittedBy: "Sarah M.",
                submittedDate: "2025-01-10T08:00:00Z",
                upvotes: 31,
                comments: 8,
                imageUrl: "placeholder-drain.jpg"
            },
            {
                id: "CIV-2025-005",
                ...
                submittedDate: "2025-01-10T07:30:00Z",
                assignedTo: "Traffic Management",
                assignedDate: "2025-01-10T07:45:00Z",
                estimatedCompletion: "2025-01-10",
                upvotes: 45,
                comments: 12,
                imageUrl: "placeholder-traffic.jpg"
            }
        ];
        ...
        this.analytics = {
            ...
            monthlyTrends: [
                {month: "Jan", submitted: 98, resolved: 92},
                {month: "Feb", submitted: 87, resolved: 89},
                {month: "Mar", submitted: 102, resolved: 95},
                {month: "Apr", submitted: 112, resolved: 108},
                {month: "May", submitted: 156, resolved: 142},
                {month: "Jun", submitted: 134, resolved: 139},
                {month: "Jul", submitted: 178, resolved: 165},
                {month: "Aug", submitted: 189, resolved: 178},
                {month: "Sep", submitted: 191, resolved: 181}
            ],
            categoryBreakdown: {
                potholes: 342,
                streetlights: 198,
        ...
        this.userReports = this.issues.filter(issue => 
            ['John D.', 'Maria S.'].includes(issue.submittedBy)
        );
    }

    generateAdditionalIssues() {
        const categories = ['potholes', 'streetlights', 'garbage', 'drainage', 'traffic', 'vandalism', 'noise', 'parks'];
        const priorities = ['low', 'medium', 'high', 'urgent'];
        const statuses = ['submitted', 'assigned', 'in-progress', 'resolved'];
        const locations = [
            'Oak Street & 1st Ave', 'Main Street Park', 'Downtown Plaza', 'Riverside Drive',
            'Central Avenue', 'Park Lane', 'Broadway & 5th', 'Maple Street', 'Elm Avenue',
            'Pine Road', 'Cedar Street', 'Birch Lane', 'Willow Drive', 'Ash Boulevard'
        ];
        ...
        for (let i = 6; i <= 50; i++) {
            ...
            const issue = {
                id: `CIV-2025-${String(i).padStart(3, '0')}`,
                title: this.generateIssueTitle(category),
                category: category,
                description: this.generateIssueDescription(category),
                location: location,
                coordinates: [40.7128 + (Math.random() - 0.5) * 0.1, -74.0060 + (Math.random() - 0.5) * 0.1],
                priority: priority,
                status: status,
                submittedBy: this.generateRandomName(),
                submittedDate: new Date(2025, 0, Math.floor(Math.random() * 10) + 1).toISOString(),
            ...
            if (status !== 'submitted') {
                issue.assignedTo = this.getDepartmentForCategory(category);
                issue.assignedDate = new Date(Date.parse(issue.submittedDate) + Math.random() * 86400000).toISOString();
            }

            if (status === 'resolved') {
                issue.resolvedDate = new Date(Date.parse(issue.assignedDate) + Math.random() * 172800000).toISOString();
            }
